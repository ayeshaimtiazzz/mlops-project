...
# ===============================
print("DEBUG: Creating required folders...")
...
# HYPERPARAMETERS
# ===============================
print("DEBUG: Setting hyperparameters...")
NUM_CLIENTS = 3
NUM_ROUNDS = 80
BATCH_SIZE = 20
...
NUM_CLASSES = 62
print("DEBUG: Hyperparameters set.")

# ===============================
# LOAD EMNIST DATA
# ===============================
print("DEBUG: Loading EMNIST data...")
...
print("DEBUG: EMNIST data loaded and preprocessed.")

# ===============================
# DEFINE MODEL
# ===============================
print("DEBUG: Defining Keras model...")
...
print("DEBUG: Model defined and TFF model created.")

# ===============================
# FEDERATED TRAINING
# ===============================
print("DEBUG: Initializing federated training...")
...
print("DEBUG: Starting Federated Training loop...")
for round_num in tqdm(range(1, NUM_ROUNDS + 1), desc="Rounds"):
    ...
    print(f"DEBUG: Evaluating test accuracy for round {round_num}...")
...
print("DEBUG: Federated training loop finished. Saving global metrics...")
pd.DataFrame({
...
print("DEBUG: Global metrics saved to CSVs.")

# ===============================
# EXTRACT TRAINED GLOBAL MODEL
# ===============================
print("DEBUG: Extracting trained global model...")
...
print("DEBUG: Global model extracted and compiled.")

# ===============================
# CENTRALIZED EVALUATION
# ===============================
print("DEBUG: Performing centralized evaluation...")
test_loss, test_accuracy = keras_model_trained.evaluate(test_ds, verbose=0)
print(f"Test Loss: {test_loss:.4f}, Test Accuracy: {test_accuracy:.4f}")
print("DEBUG: Centralized evaluation completed.")
# ===============================
# CLASSIFICATION REPORT & CONFUSION MATRIX
# ===============================
print("DEBUG: Generating classification report and confusion matrix...")
all_preds = []
all_true = []
...
print("DEBUG: Classification report and confusion matrix saved.")
...
print("DEBUG: Generating global class distribution plot...")
...
plt.close()
print("DEBUG: Global class distribution plot saved.")


# ===============================
# PER-USER PERSONALIZATION & METRICS
# ===============================
print("DEBUG: Starting per-user personalization...")
...
print("DEBUG: Per-user personalization finished.")


# ===============================
# PLOT ACCURACY OVER ROUNDS (UPDATED: Now includes test accuracy)
# ===============================
print("DEBUG: Generating accuracy over rounds plot...")
...
print("DEBUG: Accuracy over rounds plot saved.")

# ===============================
# PLOT PER-CLIENT ACCURACIES
# ===============================
print("DEBUG: Generating per-client accuracies plot...")
...
print("DEBUG: Per-client accuracies plot saved.")

# ===============================
# SAVE GLOBAL MODEL
# ===============================
print("DEBUG: Saving global model...")
